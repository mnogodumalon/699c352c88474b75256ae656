...
const APP_TITLE = 'Zutaten-Analyser';
...
const navigation = [
  ...
  { name: 'Analysen', href: '/analysen', icon: IconFileText },
  { name: 'Analyseergebnisse', href: '/analyseergebnisse', icon: IconFileText },
  { name: 'Zutatendatenbank', href: '/zutatendatenbank', icon: IconFileText },
  { name: 'Schnellanalyse', href: '/schnellanalyse', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Analysen', href: '/gateway/apps/699c3506b5c37b2fe49da856?template=list_page', icon: IconFileText },
  { name: 'Analyseergebnisse', href: '/gateway/apps/699c350783673810f82e34c4?template=list_page', icon: IconFileText },
  { name: 'Zutatendatenbank', href: '/gateway/apps/699c35017ca9d5e746867983?template=list_page', icon: IconFileText },
  { name: 'Schnellanalyse', href: '/gateway/apps/699c35083159889d7927b682?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699c3506b5c37b2fe49da856?template=list_page"
